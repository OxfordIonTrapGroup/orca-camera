ERROR_CODES = {
    ...
    '0x8000083b':
    "the frame count is larger than device momory size on using device memory.",
    '0x8000083c': "the capture mode is sequence on using device memory.",
    '0x8000083f':
    "the sysmem memory size is too small. PC doesn't have enough memory or is limited memory by 32bit OS.",
    '0x80000f03':
    ...
    '0x84002002':
    "DCAM Module Version is older than the version that the camera requests",
    '0x84002003':
    "Camre returns the error on setting parameter to limit version",
    '0x84002004': "Camera is running as a factory mode",
    '0x84003001': "sigunature of image header is unknown or corrupted",
    '0x84003002':
    "version of image header is newer than version that used DCAM supports",
    ...
    '0xE0100110':
    "the trigger mode is internal or syncreadout on using device memory.",
